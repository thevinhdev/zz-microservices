...
{
    public class LoginUserQuery : IRequest<UserLogin>
    {
        public string email { get; set; }
        public string password { get; set; }

        public class Validation: AbstractValidator<LoginUserQuery>
        {
            public Validation()
            {
        ...
        public class LoginUserHandler : IRequestHandler<LoginUserQuery, UserLogin>
        {
            ...
            public LoginUserHandler(IConfiguration configuration, IMapper mapper, IUserAsyncRepository userRepo, IAsyncRepository<Employee> empRepo,
            ...
            public async Task<UserLogin> Handle(LoginUserQuery request, CancellationToken cancellationToken)
            {
