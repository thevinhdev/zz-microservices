...
{
    public class AdminChangePassCommand : IRequest<Boolean>
    {
        public long UserId { get; set; }
        public string PasswordOld { get; set; }
        public string PasswordNew { get; set; }
        public bool IsTypeBql { get; set; }

        public class Validation : AbstractValidator<AdminChangePassCommand>
        {
            public Validation()
            {
        ...
        public class AdminChangePassHandler : IRequestHandler<AdminChangePassCommand, Boolean>
        {
            private readonly IMapper _mapper;
            private readonly IUnitOfWork _unitOfWork;
            private readonly IUserAsyncRepository _userRepo;

            public AdminChangePassHandler(IMapper mapper,
            ...
            public async Task<bool> Handle(AdminChangePassCommand request, CancellationToken cancellationToken)
            {
