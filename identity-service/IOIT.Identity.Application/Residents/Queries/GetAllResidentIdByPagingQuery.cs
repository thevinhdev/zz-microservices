...
{
    public class GetAllResidentIdByPagingQuery : FilterPagination, IRequest<IPagedResult<ResResidentIdDT>>
    {
        ...
        public class Handler : IRequestHandler<GetAllResidentIdByPagingQuery, IPagedResult<ResResidentIdDT>>
        {
            ...
            public async Task<IPagedResult<ResResidentIdDT>> Handle(GetAllResidentIdByPagingQuery request, CancellationToken cancellationToken)
            {
